...
export default function Composer({ onSend }: Props) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-[calc(3.9rem+env(safe-area-inset-bottom))] z-20 mx-auto max-w-2xl border-t border-line bg-cream/95 px-4 pt-2 pb-2 backdrop-blur">
