...
| 일어난 일 | 누구에게 |
| --- | --- |
| 대화방에 새 메시지 | 보낸 사람 빼고 가족 전체 |
| 일정·할일·숙제에 댓글 | 쓴 사람 빼고 가족 전체 |
| 할일·숙제를 만들어 배정 / 담당자 변경 | 그 담당자 ("새 숙제가 왔어요 · 제목 · 마감") |
| 아이가 할일·숙제 "다 했어요" 체크 | 부모들 ("확인해 주세요") |
| 부모가 확인(포인트 지급) | 그 아이 ("잘했어요 · +N점") |

체크 취소 같은 그 밖의 변화는 알리지 않습니다. 본인이 한 일은 본인 기기에 가지 않습니다.
